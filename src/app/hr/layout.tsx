  ...
  return (
    ...
    >
      <div className="min-h-screen px-4 py-6">
        <header className="sticky top-4 z-40 mx-auto flex w-full max-w-6xl flex-col gap-4 rounded-3xl border border-white/60 bg-white/85 px-6 py-5 shadow-[0_12px_40px_rgba(30,69,62,0.12)] backdrop-blur">
