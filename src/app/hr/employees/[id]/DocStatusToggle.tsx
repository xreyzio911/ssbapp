      ...
      {needsUpdate ? (
        ...
        <>
          ...
          <textarea
            ...
            className="w-full min-h-28 rounded-xl border border-[#1E453E]/15 bg-white px-4 py-3 text-sm leading-5 text-[#1B1B1B] shadow-sm transition placeholder:text-sm placeholder:text-[#7a7a7a] focus:border-[#1E453E] focus:outline-none focus:ring-2 focus:ring-[#1E453E]/20"
